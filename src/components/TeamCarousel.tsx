            ...
            {members.map((member, index) => {
              ...
              return (
                <motion.div
                  key={member.id}
                  className={cn(
                    "absolute bg-gray-800/50 backdrop-blur-sm border border-gray-700 overflow-hidden shadow-2xl cursor-pointer rounded-lg",
                    cardClassName
                  )}
                  style={{
                    width: cardWidth,
                ...
                >
                  ...
                  />
                  <div className="p-4">
                    <h4 className="text-white font-medium mb-1 text-sm">{member.name}</h4>
